        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    cleaning_fee_amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    price_for_period_amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    price_for_period_currency = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    cleaning_fee_amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    cleaning_fee_currency = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    amenities_up_charge_amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    amenities_up_charge_currency = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    total_price_amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
