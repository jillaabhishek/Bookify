    ...
    public static void SeedData(this IApplicationBuilder app)
    {
        ...
        for (var i = 0; i < 100; i++)
        {
            apartments.Add(new
            {
                ...
                Amenities = string.Join(",", new List<string> { ((int)Amenity.Parking).ToString(), ((int)Amenity.MountainView).ToString() }),
                LastBookedOn = (DateTime)System.Data.SqlTypes.SqlDateTime.MinValue,
                Version = faker.UniqueIndex
            });
        }
